...
class PRDValidationReportParser:
    def __init__(self) -> None:
        self.sections_parser = MarkdownSectionsParser()

    def parse(self, path: str, text: str) -> PRDValidationReportDocument:
        ...
        validation_type = fields.get('Validation Type', 'full')
    ...
    def _extract_project_name(title: str, path: str) -> str:
        import re
        m = re.match(r'PRD Validation Report:\s*(.+)', title)
        if m:
