...
class PRDMutator:
    """Workflow-aware mutations for PRDDocument.

    Supports replace_section operation for any section.
    Full artifact rewrite allowed by bmad-create-prd workflow.
    """

    def apply_operations(
        self, doc: PRDDocument, workflow_id: str, operations: list[dict], contract
    ) -> PRDDocument:
