...
class UXDesignMutator:
    """Workflow-aware mutations for UXDesignDocument.

    Supports replace_section operation for any section.
    Full artifact rewrite allowed by bmad-create-ux-design workflow.
    """

    def apply_operations(
        self, doc: UXDesignDocument, workflow_id: str, operations: list[dict], contract
    ) -> UXDesignDocument:
