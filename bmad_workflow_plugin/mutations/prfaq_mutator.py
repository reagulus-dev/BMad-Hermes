...
class PRFAQMutator:
    """Workflow-aware mutations for PRFAQDocument.

    Supports replace_section operation for any section.
    Full artifact rewrite allowed by bmad-prfaq workflow.
    """

    def apply_operations(
        self, doc: PRFAQDocument, workflow_id: str, operations: list[dict], contract
    ) -> PRFAQDocument:
